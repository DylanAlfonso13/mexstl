...
export const storyChapters: StoryChapter[] = [
  ...
  },
  {
    ...
    description: {
      ...
      es: 'En 1902, la gerencia general del Ferrocarril Central Mexicano en los Estados Unidos fue trasladada de Boston a St. Louis. Henry Clay Pierce, presidente de la compañía petrolera Waters-Pierce, lideró el movimiento para desarrollar el Oeste de América, donde St. Louis era la metropolis. De acuerdo al artículo del St. Louis Dispatch, la nueva gerencia general iba a estar ubicada en el <a href="https://www.builtstlouis.net/opos/chamber.html" target="_blank" rel="noopener noreferrer">Banco Nacional de Comercio</a> de St. Louis, junto a North Broadway y Olive Street.'
    },
